...
import 'package:puja_ltd/features/product_loan/service/product_loan_service.dart';

class ProductLoanRequestScreen extends StatelessWidget {
  ProductLoanRequestScreen({Key? key}) : super(key: key);
              ...
              RoundButtonWidget(
                  ...
                  function: () {
                    if (_formKey.currentState!.validate()) {
                      ProductLoanService().sendProductLoanRequest(
                          amount: amount.text,
                          meth: meth.text,
                          descr: descr.text);
                    }
