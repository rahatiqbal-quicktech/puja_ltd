            ...
            children: [
              ...
              Container(
                ...
                child: ListTile(
                  ...
                  leading: const Icon(Icons.punch_clock),
                  title: nomineeDob == null
                      ? const Text("Nominee Date of birth")
                      : Text(
                          "${nomineeDob?.day} - ${nomineeDob?.month} - ${nomineeDob?.year}"),
                ),
              ),
              const VerticalSpace(height: 10),
              ThemeColorTextFormField(
                  ...
                  function: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      if (imageFile == null ||
                          ...
                          nomineeImage == null ||
                          nomineeSignatureImage == null) {
                        Fluttertoast.showToast(msg: "Add all the images");
                      } else {
                        SignUpService().signUpStatic(
                            ...
                            monthlyIncome: monthlyIncome.text,
                            dob: "$dob",
                            academicQualification: academicQualification.text,
                            nid: nid.text,
                            contactNo: contactNo.text,
                            password: password.text,
                            email: email.text,
